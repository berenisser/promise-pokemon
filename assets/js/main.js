$(document).ready(function() {
	var llamarHabilidades = function(urlHabilidades){
		...
		.done(function(respuesta) {
			...
			$("#"+nombreID).append('<div class="foto-poke text-center col-lg-12 col-md-12 col-sm-12 col-xs-12"><img src="'+foto+'">');
		...
		.done(function(respuesta){
			...
			$("#"+nombreID).append('<div class="text-center capitalizar poder">'+type2+'</div></div><center>Habilidades</center>');
